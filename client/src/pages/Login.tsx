...
<<<<<<< HEAD
                      className={`flex flex-col items-center gap-1.5 p-3 rounded-lg border-2 transition-all text-center font-medium ${selectedRole === r.value
...
>>>>>>> 652c575 (feat: initialize full-stack HireLoop project with client-side UI components and server-side API architecture)
